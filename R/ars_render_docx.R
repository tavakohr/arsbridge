...
## (unsupported analysis, or a render error). Keeps the final document
## complete and the table numbering aligned to the shell.
.add_placeholder <- function(doc, heading, title, reason, first) {
  ...
  doc <- officer::body_add_par(
    doc,
    sprintf("[ Placeholder -- not generated by arsbridge: %s. Produce this table manually. ]",
            reason %||% "unsupported"))
  doc
}
