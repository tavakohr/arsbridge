  ...
  for (i in seq_along(enriched)) {
    ...
    if (!cap$supported) {
      ...
      .diag_gap(
        ...
        fix = "Produce this table from a separate validated analysis script. arsbridge emits a numbered placeholder for it in the final output so the table numbering still matches your shell. See docs/adr/0001-statistical-method-extensibility.md for why this boundary exists and how it is extended.",
