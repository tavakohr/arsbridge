...
The deterministic reader recognises several TLF heading styles out of the box:
a bare `Table 14.1.1`, a colon inline title (`Table 14.1.1: Title`), and a
one-line heading that carries the title, a dash-separated population, an inline
annotation, and a `[PROGRAMMING DATASETS USED: ...]` suffix together. If a
sponsor's headings follow a different convention, pass a custom PCRE pattern
via `spec_to_ars(heading_patterns = ...)` (named `number`/`type`/`title`
groups; see `?spec_to_ars`).
