...
<figure>
<img src="man/figures/README-editor.png"
alt="The review stage on the bundled example study: the shell’s structure on the left, the selected analysis as spec-constrained fields on the right." />
<figcaption aria-hidden="true">The review stage on the bundled example
study: the shell’s structure on the left, the selected analysis as
spec-constrained fields on the right.</figcaption>
</figure>
